...
if (!isset($_SESSION['submit'])) {
	...
	if ("SELECT FROM users WHERE actions_completed='$actions_completed'");
	   {
...
<div class="fixed-size-square">
	...
	<section class="submitaction">
		<a href="action2.php" style="text-decoration: none; color: inherit">
...
<?php  
				...
				$result = mysqli_query($con,"SELECT * FROM actions1 ORDER BY RAND() LIMIT 0,1;");
